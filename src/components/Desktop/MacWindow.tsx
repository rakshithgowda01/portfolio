...
export const MacWindow = ({
  ...
  return (
    ...
    >
      <div className="bg-white/95 backdrop-blur-md border border-gray-300 rounded-xl overflow-hidden">
        ...
        <div className="window-header flex items-center justify-between px-3 md:px-4 py-2 md:py-3 bg-gradient-to-r from-white/5 to-white/10 border-b border-gray-200 cursor-move">
          ...
          {/* Title */}
          <h3 className="text-xs md:text-sm font-medium text-gray-800 flex-1 text-center truncate px-2">
            {title}
          </h3>
