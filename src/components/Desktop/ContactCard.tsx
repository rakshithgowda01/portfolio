...
export const ContactCard = ({ onClose, centered = false }: ContactCardProps) => {
              ...
              <>
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <div className="flex justify-center space-x-4">
                    {/* Instagram */}
                    <a href="https://www.instagram.com/rakshithgowda_.1" target="_blank" rel="noreferrer" className="w-10 h-10 bg-gradient-to-br from-slate-600 via-slate-700 to-emerald-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/rakshithgowdarprofile/" target="_blank" rel="noreferrer" className="w-10 h-10 bg-slate-700 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg">
                      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* GitHub */}
                    <a href="https://github.com/rakshithgowda01" target="_blank" rel="noreferrer" className="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg">
                      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* Email */}
                    <a href="mailto:selfzorojuro@gmail.com" className="w-10 h-10 bg-emerald-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg">
                      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex justify-center pt-4">
                    <HoverBorderGradient
                      ...
                      className="bg-slate-800 text-white flex items-center space-x-2"
                      as="button"
                      duration={1}
                      clockwise={true}
                    >
